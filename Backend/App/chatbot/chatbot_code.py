...
# api_key = "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"
...
async def real_estate_chatbot(user_message: str) -> str:
    ...
    **لطفاً مشخص کنید که پیام کاربر به کدام یک از این دسته‌ها تعلق دارد:**
    ...
    مثال‌های اشتباه (نباید `district_search` بشن):
        ...
        - "یه واحد یک‌خوابه با قیمت یک میلیون می‌خوام"
    ---
